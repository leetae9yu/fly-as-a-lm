# Original reward-learning prototype

This document preserves the original CPU binary-task experiment. For the current
autoregressive language model, start with [README.md](README.md). The later
reward-based text experiment remains in [LANGUAGE.md](LANGUAGE.md) and
[LANGUAGE_RESULTS.md](LANGUAGE_RESULTS.md).
